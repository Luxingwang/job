//
//  ManageCollectionTagsFlowLayout.m
...
@interface ManageCollectionTagsFlowLayout()

/** 在居中对齐的时候需要知道这行所有cell的宽度总和 */
@property (nonatomic, assign) CGFloat sumWidth;
@end
@implementation ManageCollectionTagsFlowLayout
...
{
    NSArray *layoutAttributesSuper = [super layoutAttributesForElementsInRect:rect];
    NSArray *layoutAttributes = [[NSArray alloc]initWithArray:layoutAttributesSuper copyItems:YES];
    // 用来临时存放一行的Cell数组
